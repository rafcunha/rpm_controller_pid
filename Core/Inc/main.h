...
#define btn_parada_Pin GPIO_PIN_3
#define btn_parada_GPIO_Port GPIOC
#define btn_parada_EXTI_IRQn EXTI3_IRQn
...
#define btn_rotina_teste_Pin GPIO_PIN_4
#define btn_rotina_teste_GPIO_Port GPIOC
#define btn_rotina_teste_EXTI_IRQn EXTI4_IRQn
